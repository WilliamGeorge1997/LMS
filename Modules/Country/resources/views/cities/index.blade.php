    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack my-3">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <a href="#create-collapse" id="create-toggle" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="collapse"
                ...
                <span id="create-toggle-label">+ Create City</span>
            </a>
        </div>
    </div>
                        ...
                        <div class="row g-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="title_en" class="form-control form-control-solid"
                                    placeholder="English title" data-rule-required data-rule-max="255"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="title_ar" class="form-control form-control-solid"
                                    placeholder="Arabic title" data-rule-required data-rule-max="255"
...
@section('js')
    ...
    <script>
        ...
        KTUtil.onDOMContentLoaded(function() {
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return `<span class="badge badge-light-primary fw-bold">${row.country_label ?? ""}</span>`;
                        }
                    },
                    {
                        targets: 5,
            ...
            // ── 4. EditPlugin ─────────────────────────────────────────────────────
            EditPlugin.init({
                updateUrl: "{{ route('cities.update', ['city' => ':id']) }}",
                datatable: dt,
                selector: ".edit-btn",
                columns: [{
                        field: "title_en",
                ...
                notifications: {
                    ...
                    successText: "City updated successfully.",
                    errorTitle: "Error",
            ...
            // ── 5. Toggle Plugin ────────────────────────────────────────────────
            TogglePlugin.init({
                toggleUrl: "{{ route('cities.toggle-activate', ['city' => ':id']) }}",
