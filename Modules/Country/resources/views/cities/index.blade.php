    ...
    <div id="create-toolbar-area">
        ...
        <div class="app-container container-fluid mb-7">
            <div id="create-collapse" class="collapse">
                @include('country::cities.partials.create')
            </div>
        </div>
    </div>
@endsection
...
@section('js')
    ...
    <script>
        ...
        Actions.initEdit(dt, "{{ url('/admin/cities') }}/:id/edit");
        Actions.initDelete(dt, "{{ url('/admin/cities') }}/:id");
        Actions.initToggle("{{ url('/admin/cities') }}/:id/toggle-activate");
    </script>
@endsection
