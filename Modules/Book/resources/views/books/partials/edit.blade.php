...
<tr class="edit-inline-row" data-edit-form-id="{{ $book->id }}">
    ...
    <td>
        <input form="{{ $formId }}" type="text" name="isbn" class="form-control form-control-solid form-control-sm"
    ...
    <td>
        <select form="{{ $formId }}" name="level_id" class="form-select form-select-solid form-select-sm"
        ...
        <div class="additional-fields-panel rounded-2 p-5 m-2">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <textarea form="{{ $formId }}" name="description_ar" rows="3"
                        class="form-control form-control-solid form-control-sm"
