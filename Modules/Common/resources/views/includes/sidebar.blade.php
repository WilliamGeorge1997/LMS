        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
            ...
            <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true"
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu"
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if ($request->routeIs('book-codes.index')) active @endif"
                            href="{{ url('/admin/book-codes') }}">
                            <span class="menu-icon">
                            ...
                            <span class="menu-title">{{ __('book::attributes.book_codes') }}</span>
                        </a>
                    </div>
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link @if ($request->routeIs('settings.index')) active @endif"
                            ...
                            <span class="menu-title">{{ __('common::sidebar.settings') }}</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
