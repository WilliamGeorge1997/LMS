    ...
    <div id="create-toolbar-area">
        ...
        <div class="app-container container-fluid mb-7">
            <div id="create-collapse" class="collapse">
                @include('publisher::publishers.partials.create')
            </div>
        </div>
    </div>
@endsection
...
@section('js')
    ...
    var dt = $('#kt_datatable').DataTable({
        ...
        Actions.initEdit(dt, "{{ url('/admin/publishers') }}/:id/edit");
        Actions.initDelete(dt, "{{ url('/admin/publishers') }}/:id");
        Actions.initToggle("{{ url('/admin/publishers') }}/:id/toggle-activate");
    </script>
@endsection
